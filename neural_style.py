...
def build_parser():
    ...
    parser.add_argument('--content',
            ...
            metavar='CONTENT', required=True, default="examples/1-content.jpg")
    parser.add_argument('--styles',
            dest='styles',
            nargs='+', help='one or more style images',
            metavar='STYLE', required=True, default="examples/1-style.jpg")
    parser.add_argument('--output',
            dest='output', help='output path',
            metavar='OUTPUT', required=True, default="examples/1-output.jpg")
    ...
    parser.add_argument('--keep-colors', action='store_true',
            dest='keep_colors',
            help='style-only transfer (keep colors) - if color transfer '
                 'is not needed')
...
def main():
    ...
    for iteration, image, loss_vals in stylize(
        ...
        styles=style_images,
        keep_colors=options.keep_colors,
